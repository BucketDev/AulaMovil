...
export class ActivitiesService {
  ...
  findAllByGroupUid = () => this.getDocumentGroup()
    ...
    .pipe(map((documents: DocumentChangeAction<Activity>[]) =>
      documents.map((action: DocumentChangeAction<Activity>) => {
        ...
        if (activity.dueDate instanceof firestore.Timestamp) {
  ...
  findAllByDueDates = (initialDate: firestore.Timestamp, finalDate: firestore.Timestamp) => this.getDocumentGroup()
  ...
  findAllByNoDueDateAndDueDates = (initialDate: firestore.Timestamp, finalDate: firestore.Timestamp) => this.getDocumentGroup()
    .collection(this.collectionName, ref => ref.orderBy('dueDate').orderBy('position')
